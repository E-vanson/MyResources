...
<body class="w-screen h-screen flex items-center justify-center">
    ...
    <div class="flex w-1/2 h-3/5 border-2 border-[#47A3FF] rounded-lg shadow-lg">
        ...
        <section class="w-1/2 h-full flex flex-col items-center justify-evenly">
            ...
            <!-- input division -->
            <form action="loginCode.php" method="post" class="relative w-full h-3/5 flex flex-col justify-evenly items-center">             
            ...
            <div class="">
                <h5 class="text-sm">
                    ...
                    <a href="resend-email-verification.php" class="text-xs text-[Blue] hover:text-[#47A3FF] underline">
                        Resend
                    </a>
                </h5>
                <p class="text-sm">
